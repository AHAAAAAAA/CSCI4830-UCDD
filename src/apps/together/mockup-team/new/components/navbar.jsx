      ...
      <nav>
        <div className="nav-wrapper light-green darken-3">
          <div className="container">
            <a href="/apps/together/mockup-team/new/index.html" className="brand-logo">Polive <img src="/apps/together/mockup-team/categories/olive.png" height="20px" style="margin-top:15px;"/> </a>
